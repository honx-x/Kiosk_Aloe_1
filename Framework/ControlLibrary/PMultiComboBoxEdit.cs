...
namespace TLF.Framework.ControlLibrary
{
    ...
    /// 
    /// </remarks>
    public partial class PMultiComboBoxEdit : DevExpress.XtraEditors.LookUpEdit
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// <summary>
        /// MultiComboBoxEdit Control을 생성합니다.
        /// </summary>
        public PMultiComboBoxEdit()
        {
            InitializeComponent();
        } 
        ...
        #region :: ShowHeader :: Column Header 숨김/표시 여부를 설정합니다.

        /// <summary>
        /// Column Header 숨김/표시 여부를 설정합니다.
        /// </summary>
        [Category(AppConfig.CONTROLCATEGORY)]
        [Description("Column Header 숨김/표시 여부를 설정합니다."), Browsable(true)]
        ...
        public void InitData(DataTable dt, string valueMember, string displayMember)
        {
            ...
            {
                Properties.Columns.Add(column == valueMember ? CreateColumn(column, column, 70, HorzAlignment.Center, _codeColumnVisible) : CreateColumn(column, column, 120, HorzAlignment.Default, true));
            });

            Properties.ShowHeader = Properties.Columns.Count < 3 ? false : true;
