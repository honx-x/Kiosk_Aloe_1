namespace TLF.Framework.ControlLibrary
{
	partial class DocEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.richEditBar = new DevExpress.XtraRichEdit.UI.RichEditBarController();
			...
			((System.ComponentModel.ISupportInitialize)(this.richEditBar)).BeginInit();
			this.SuspendLayout();
			// 
			// richEdit
			// 
			this.richEdit.ActiveViewType = DevExpress.XtraRichEdit.RichEditViewType.Draft;
			this.richEdit.Appearance.Text.Font = new System.Drawing.Font("굴림체", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.richEdit.Appearance.Text.Options.UseFont = true;
			this.richEdit.Dock = System.Windows.Forms.DockStyle.Fill;
			this.richEdit.LayoutUnit = DevExpress.XtraRichEdit.DocumentLayoutUnit.Document;
			this.richEdit.Location = new System.Drawing.Point(0, 145);
			this.richEdit.MenuManager = this.ribbon;
			this.richEdit.Name = "richEdit";
			this.richEdit.Options.MailMerge.KeepLastParagraph = true;
			this.richEdit.Size = new System.Drawing.Size(1007, 320);
			this.richEdit.TabIndex = 0;
			this.richEdit.Views.DraftView.AllowDisplayLineNumbers = true;
			this.richEdit.Views.SimpleView.AllowDisplayLineNumbers = true;
			// 
			// ribbon
			// 
			this.ribbon.ApplicationButtonDropDownControl = this.richEdit;
			...
			this.ribbon.Size = new System.Drawing.Size(1007, 145);
			// 
			// fileNewItem1
			// 
			...
			// 
			this.toggleTableCellsInsideVerticalBorderItem1.Id = 159;
			...
			// 
			this.toggleShowTableGridLinesItem1.Id = 160;
			...
			// 
			this.selectTableElementsItem1.Id = 164;
			...
			// 
			this.toggleTableCellsMiddleLeftAlignmentItem1.Id = 187;
			...
			// 
			this.toggleTableCellsBottomLeftAlignmentItem1.Id = 188;
			...
			// 
			this.toggleTableCellsTopCenterAlignmentItem1.Id = 189;
			...
			// 
			this.toggleTableCellsMiddleCenterAlignmentItem1.Id = 190;
			...
			this.changeFloatingObjectOutlineWeightItem1.Id = 198;
			...
			// 
			this.changeFloatingObjectTextWrapTypeItem1.Id = 199;
			...
			// 
			this.setFloatingObjectSquareTextWrapTypeItem1.Id = 200;
			...
			// 
			this.setFloatingObjectTightTextWrapTypeItem1.Id = 201;
			...
			// 
			this.setFloatingObjectThroughTextWrapTypeItem1.Id = 202;
			...
			// 
			this.setFloatingObjectTopAndBottomTextWrapTypeItem1.Id = 203;
			...
			// 
			this.setFloatingObjectBehindTextWrapTypeItem1.Id = 204;
			...
			// 
			this.setFloatingObjectInFrontOfTextWrapTypeItem1.Id = 205;
			...
			// 
			this.changeFloatingObjectAlignmentItem1.Id = 206;
			...
			// 
			this.setFloatingObjectTopLeftAlignmentItem1.Id = 207;
			...
			// 
			this.setFloatingObjectTopCenterAlignmentItem1.Id = 208;
			...
			// 
			this.setFloatingObjectTopRightAlignmentItem1.Id = 209;
			...
			// 
			this.setFloatingObjectMiddleLeftAlignmentItem1.Id = 210;
			...
			// 
			this.setFloatingObjectMiddleCenterAlignmentItem1.Id = 211;
			...
			// 
			this.setFloatingObjectMiddleRightAlignmentItem1.Id = 212;
			...
			// 
			this.setFloatingObjectBottomLeftAlignmentItem1.Id = 213;
			...
			// 
			this.setFloatingObjectBottomCenterAlignmentItem1.Id = 214;
			...
			// 
			this.setFloatingObjectBottomRightAlignmentItem1.Id = 215;
			...
			// 
			this.floatingObjectBringForwardSubItem1.Id = 216;
			...
			// richEditBar
			// 
			this.richEditBar.BarItems.Add(this.fileNewItem1);
			this.richEditBar.BarItems.Add(this.fileOpenItem1);
			this.richEditBar.BarItems.Add(this.fileSaveItem1);
			this.richEditBar.BarItems.Add(this.fileSaveAsItem1);
			this.richEditBar.BarItems.Add(this.quickPrintItem1);
			this.richEditBar.BarItems.Add(this.printItem1);
			this.richEditBar.BarItems.Add(this.printPreviewItem1);
			this.richEditBar.BarItems.Add(this.undoItem1);
			this.richEditBar.BarItems.Add(this.redoItem1);
			this.richEditBar.BarItems.Add(this.pasteItem1);
			this.richEditBar.BarItems.Add(this.cutItem1);
			this.richEditBar.BarItems.Add(this.copyItem1);
			this.richEditBar.BarItems.Add(this.pasteSpecialItem1);
			this.richEditBar.BarItems.Add(this.changeFontNameItem1);
			this.richEditBar.BarItems.Add(this.changeFontSizeItem1);
			this.richEditBar.BarItems.Add(this.fontSizeIncreaseItem1);
			this.richEditBar.BarItems.Add(this.fontSizeDecreaseItem1);
			this.richEditBar.BarItems.Add(this.toggleFontBoldItem1);
			this.richEditBar.BarItems.Add(this.toggleFontItalicItem1);
			this.richEditBar.BarItems.Add(this.toggleFontUnderlineItem1);
			this.richEditBar.BarItems.Add(this.toggleFontDoubleUnderlineItem1);
			this.richEditBar.BarItems.Add(this.toggleFontStrikeoutItem1);
			this.richEditBar.BarItems.Add(this.toggleFontDoubleStrikeoutItem1);
			this.richEditBar.BarItems.Add(this.toggleFontSuperscriptItem1);
			this.richEditBar.BarItems.Add(this.toggleFontSubscriptItem1);
			this.richEditBar.BarItems.Add(this.changeFontColorItem1);
			this.richEditBar.BarItems.Add(this.changeFontBackColorItem1);
			this.richEditBar.BarItems.Add(this.changeTextCaseItem1);
			this.richEditBar.BarItems.Add(this.makeTextUpperCaseItem1);
			this.richEditBar.BarItems.Add(this.makeTextLowerCaseItem1);
			this.richEditBar.BarItems.Add(this.toggleTextCaseItem1);
			this.richEditBar.BarItems.Add(this.clearFormattingItem1);
			this.richEditBar.BarItems.Add(this.toggleBulletedListItem1);
			this.richEditBar.BarItems.Add(this.toggleNumberingListItem1);
			this.richEditBar.BarItems.Add(this.toggleMultiLevelListItem1);
			this.richEditBar.BarItems.Add(this.decreaseIndentItem1);
			this.richEditBar.BarItems.Add(this.increaseIndentItem1);
			this.richEditBar.BarItems.Add(this.toggleParagraphAlignmentLeftItem1);
			this.richEditBar.BarItems.Add(this.toggleParagraphAlignmentCenterItem1);
			this.richEditBar.BarItems.Add(this.toggleParagraphAlignmentRightItem1);
			this.richEditBar.BarItems.Add(this.toggleParagraphAlignmentJustifyItem1);
			this.richEditBar.BarItems.Add(this.toggleShowWhitespaceItem1);
			this.richEditBar.BarItems.Add(this.changeParagraphLineSpacingItem1);
			this.richEditBar.BarItems.Add(this.setSingleParagraphSpacingItem1);
			this.richEditBar.BarItems.Add(this.setSesquialteralParagraphSpacingItem1);
			this.richEditBar.BarItems.Add(this.setDoubleParagraphSpacingItem1);
			this.richEditBar.BarItems.Add(this.showLineSpacingFormItem1);
			this.richEditBar.BarItems.Add(this.addSpacingBeforeParagraphItem1);
			this.richEditBar.BarItems.Add(this.removeSpacingBeforeParagraphItem1);
			this.richEditBar.BarItems.Add(this.addSpacingAfterParagraphItem1);
			this.richEditBar.BarItems.Add(this.removeSpacingAfterParagraphItem1);
			this.richEditBar.BarItems.Add(this.changeParagraphBackColorItem1);
			this.richEditBar.BarItems.Add(this.galleryChangeStyleItem1);
			this.richEditBar.BarItems.Add(this.findItem1);
			this.richEditBar.BarItems.Add(this.replaceItem1);
			this.richEditBar.BarItems.Add(this.insertPageBreakItem1);
			this.richEditBar.BarItems.Add(this.insertTableItem1);
			this.richEditBar.BarItems.Add(this.insertPictureItem1);
			this.richEditBar.BarItems.Add(this.insertFloatingPictureItem1);
			this.richEditBar.BarItems.Add(this.insertBookmarkItem1);
			this.richEditBar.BarItems.Add(this.insertHyperlinkItem1);
			this.richEditBar.BarItems.Add(this.editPageHeaderItem1);
			this.richEditBar.BarItems.Add(this.editPageFooterItem1);
			this.richEditBar.BarItems.Add(this.insertPageNumberItem1);
			this.richEditBar.BarItems.Add(this.insertPageCountItem1);
			this.richEditBar.BarItems.Add(this.insertTextBoxItem1);
			this.richEditBar.BarItems.Add(this.insertSymbolItem1);
			this.richEditBar.BarItems.Add(this.changeSectionPageMarginsItem1);
			this.richEditBar.BarItems.Add(this.setNormalSectionPageMarginsItem1);
			this.richEditBar.BarItems.Add(this.setNarrowSectionPageMarginsItem1);
			this.richEditBar.BarItems.Add(this.setModerateSectionPageMarginsItem1);
			this.richEditBar.BarItems.Add(this.setWideSectionPageMarginsItem1);
			this.richEditBar.BarItems.Add(this.showPageMarginsSetupFormItem1);
			this.richEditBar.BarItems.Add(this.changeSectionPageOrientationItem1);
			this.richEditBar.BarItems.Add(this.setPortraitPageOrientationItem1);
			this.richEditBar.BarItems.Add(this.setLandscapePageOrientationItem1);
			this.richEditBar.BarItems.Add(this.changeSectionPaperKindItem1);
			this.richEditBar.BarItems.Add(this.changeSectionColumnsItem1);
			this.richEditBar.BarItems.Add(this.setSectionOneColumnItem1);
			this.richEditBar.BarItems.Add(this.setSectionTwoColumnsItem1);
			this.richEditBar.BarItems.Add(this.setSectionThreeColumnsItem1);
			this.richEditBar.BarItems.Add(this.showColumnsSetupFormItem1);
			this.richEditBar.BarItems.Add(this.insertBreakItem1);
			this.richEditBar.BarItems.Add(this.insertPageBreakItem2);
			this.richEditBar.BarItems.Add(this.insertColumnBreakItem1);
			this.richEditBar.BarItems.Add(this.insertSectionBreakNextPageItem1);
			this.richEditBar.BarItems.Add(this.insertSectionBreakEvenPageItem1);
			this.richEditBar.BarItems.Add(this.insertSectionBreakOddPageItem1);
			this.richEditBar.BarItems.Add(this.changeSectionLineNumberingItem1);
			this.richEditBar.BarItems.Add(this.setSectionLineNumberingNoneItem1);
			this.richEditBar.BarItems.Add(this.setSectionLineNumberingContinuousItem1);
			this.richEditBar.BarItems.Add(this.setSectionLineNumberingRestartNewPageItem1);
			this.richEditBar.BarItems.Add(this.setSectionLineNumberingRestartNewSectionItem1);
			this.richEditBar.BarItems.Add(this.toggleParagraphSuppressLineNumbersItem1);
			this.richEditBar.BarItems.Add(this.showLineNumberingFormItem1);
			this.richEditBar.BarItems.Add(this.changePageColorItem1);
			this.richEditBar.BarItems.Add(this.insertTableOfContentsItem1);
			this.richEditBar.BarItems.Add(this.updateTableOfContentsItem1);
			this.richEditBar.BarItems.Add(this.addParagraphsToTableOfContentItem1);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem1);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem2);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem3);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem4);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem5);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem6);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem7);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem8);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem9);
			this.richEditBar.BarItems.Add(this.setParagraphHeadingLevelItem10);
			this.richEditBar.BarItems.Add(this.insertCaptionPlaceholderItem1);
			this.richEditBar.BarItems.Add(this.insertFiguresCaptionItems1);
			this.richEditBar.BarItems.Add(this.insertTablesCaptionItems1);
			this.richEditBar.BarItems.Add(this.insertEquationsCaptionItems1);
			this.richEditBar.BarItems.Add(this.insertTableOfFiguresPlaceholderItem1);
			this.richEditBar.BarItems.Add(this.insertTableOfFiguresItems1);
			this.richEditBar.BarItems.Add(this.insertTableOfTablesItems1);
			this.richEditBar.BarItems.Add(this.insertTableOfEquationsItems1);
			this.richEditBar.BarItems.Add(this.insertMergeFieldItem1);
			this.richEditBar.BarItems.Add(this.showAllFieldCodesItem1);
			this.richEditBar.BarItems.Add(this.showAllFieldResultsItem1);
			this.richEditBar.BarItems.Add(this.toggleViewMergedDataItem1);
			this.richEditBar.BarItems.Add(this.checkSpellingItem1);
			this.richEditBar.BarItems.Add(this.protectDocumentItem1);
			this.richEditBar.BarItems.Add(this.changeRangeEditingPermissionsItem1);
			this.richEditBar.BarItems.Add(this.unprotectDocumentItem1);
			this.richEditBar.BarItems.Add(this.switchToSimpleViewItem1);
			this.richEditBar.BarItems.Add(this.switchToDraftViewItem1);
			this.richEditBar.BarItems.Add(this.switchToPrintLayoutViewItem1);
			this.richEditBar.BarItems.Add(this.toggleShowHorizontalRulerItem1);
			this.richEditBar.BarItems.Add(this.toggleShowVerticalRulerItem1);
			this.richEditBar.BarItems.Add(this.zoomOutItem1);
			this.richEditBar.BarItems.Add(this.zoomInItem1);
			this.richEditBar.BarItems.Add(this.goToPageHeaderItem1);
			this.richEditBar.BarItems.Add(this.goToPageFooterItem1);
			this.richEditBar.BarItems.Add(this.goToNextHeaderFooterItem1);
			this.richEditBar.BarItems.Add(this.goToPreviousHeaderFooterItem1);
			this.richEditBar.BarItems.Add(this.toggleLinkToPreviousItem1);
			this.richEditBar.BarItems.Add(this.toggleDifferentFirstPageItem1);
			this.richEditBar.BarItems.Add(this.toggleDifferentOddAndEvenPagesItem1);
			this.richEditBar.BarItems.Add(this.closePageHeaderFooterItem1);
			this.richEditBar.BarItems.Add(this.changeTableCellsShadingItem1);
			this.richEditBar.BarItems.Add(this.changeTableBordersItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsBottomBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsTopBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsLeftBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsRightBorderItem1);
			this.richEditBar.BarItems.Add(this.resetTableCellsAllBordersItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsAllBordersItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsOutsideBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsInsideBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsInsideHorizontalBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsInsideVerticalBorderItem1);
			this.richEditBar.BarItems.Add(this.toggleShowTableGridLinesItem1);
			this.richEditBar.BarItems.Add(this.changeTableBorderLineStyleItem1);
			this.richEditBar.BarItems.Add(this.changeTableBorderLineWeightItem1);
			this.richEditBar.BarItems.Add(this.changeTableBorderColorItem1);
			this.richEditBar.BarItems.Add(this.selectTableElementsItem1);
			this.richEditBar.BarItems.Add(this.selectTableCellItem1);
			this.richEditBar.BarItems.Add(this.selectTableColumnItem1);
			this.richEditBar.BarItems.Add(this.selectTableRowItem1);
			this.richEditBar.BarItems.Add(this.selectTableItem1);
			this.richEditBar.BarItems.Add(this.showTablePropertiesFormItem1);
			this.richEditBar.BarItems.Add(this.deleteTableElementsItem1);
			this.richEditBar.BarItems.Add(this.showDeleteTableCellsFormItem1);
			this.richEditBar.BarItems.Add(this.deleteTableColumnsItem1);
			this.richEditBar.BarItems.Add(this.deleteTableRowsItem1);
			this.richEditBar.BarItems.Add(this.deleteTableItem1);
			this.richEditBar.BarItems.Add(this.insertTableRowAboveItem1);
			this.richEditBar.BarItems.Add(this.insertTableRowBelowItem1);
			this.richEditBar.BarItems.Add(this.insertTableColumnToLeftItem1);
			this.richEditBar.BarItems.Add(this.insertTableColumnToRightItem1);
			this.richEditBar.BarItems.Add(this.mergeTableCellsItem1);
			this.richEditBar.BarItems.Add(this.showSplitTableCellsForm1);
			this.richEditBar.BarItems.Add(this.splitTableItem1);
			this.richEditBar.BarItems.Add(this.toggleTableAutoFitItem1);
			this.richEditBar.BarItems.Add(this.toggleTableAutoFitContentsItem1);
			this.richEditBar.BarItems.Add(this.toggleTableAutoFitWindowItem1);
			this.richEditBar.BarItems.Add(this.toggleTableFixedColumnWidthItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsTopLeftAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsMiddleLeftAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsBottomLeftAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsTopCenterAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsMiddleCenterAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsBottomCenterAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsTopRightAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsMiddleRightAlignmentItem1);
			this.richEditBar.BarItems.Add(this.toggleTableCellsBottomRightAlignmentItem1);
			this.richEditBar.BarItems.Add(this.showTableOptionsFormItem1);
			this.richEditBar.BarItems.Add(this.changeFloatingObjectFillColorItem1);
			this.richEditBar.BarItems.Add(this.changeFloatingObjectOutlineColorItem1);
			this.richEditBar.BarItems.Add(this.changeFloatingObjectOutlineWeightItem1);
			this.richEditBar.BarItems.Add(this.changeFloatingObjectTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectSquareTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectTightTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectThroughTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectTopAndBottomTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectBehindTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectInFrontOfTextWrapTypeItem1);
			this.richEditBar.BarItems.Add(this.changeFloatingObjectAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectTopLeftAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectTopCenterAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectTopRightAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectMiddleLeftAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectMiddleCenterAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectMiddleRightAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectBottomLeftAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectBottomCenterAlignmentItem1);
			this.richEditBar.BarItems.Add(this.setFloatingObjectBottomRightAlignmentItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectBringForwardSubItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectBringForwardItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectBringToFrontItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectBringInFrontOfTextItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectSendBackwardSubItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectSendBackwardItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectSendToBackItem1);
			this.richEditBar.BarItems.Add(this.floatingObjectSendBehindTextItem1);
			this.richEditBar.Control = this.richEdit;
			// 
			...
			this.Name = "DocEditor";
			this.Size = new System.Drawing.Size(1007, 465);
			...
			((System.ComponentModel.ISupportInitialize)(this.richEditBar)).EndInit();
		...
		private DevExpress.XtraRichEdit.UI.RichEditBarController richEditBar;
