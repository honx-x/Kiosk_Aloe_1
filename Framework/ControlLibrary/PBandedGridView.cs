...
namespace TLF.Framework.ControlLibrary
{
    ...
    /// 
    /// </summary>
    public partial class PBandedGridView : DevExpress.XtraGrid.Views.BandedGrid.BandedGridView
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            InitGridColumn(bandName, fieldName, caption, width, 0, false, true);
        }
        ...
        /// 
        /// </remarks>
        public void InitGridColumn(string bandName, string fieldName, string caption, int width, int maxLength, bool allowEdit, bool visible)
        {
            InitGridColumn(bandName, fieldName, caption, width, maxLength, allowEdit, visible, ColumnDataType.Default, HorzAlignment.Default);
        }
        ...
        /// 
        /// </remarks>
        public void InitGridColumn(string bandName, string fieldName, string caption, int width, int maxLength, bool allowEdit, bool visible, ColumnDataType dataType)
        {
            InitGridColumn(bandName, fieldName, caption, width, maxLength, 0, allowEdit, visible, dataType, HorzAlignment.Default);
        }
        ...
        public void InitGridColumn(string bandName, string fieldName, string caption, int width, int maxLength, bool allowEdit, bool visible, ColumnDataType dataType, HorzAlignment horzAlign)
        {
            InitGridColumn(bandName, fieldName, caption, width, maxLength, 0, allowEdit, visible, dataType, horzAlign);
        }
        ...
        /// 
        /// </remarks>
        public void InitGridColumn(string bandName, string fieldName, string caption, int width, int maxLength, int decimalPlace, bool allowEdit, bool visible, ColumnDataType dataType, HorzAlignment horzAlign)
        {
