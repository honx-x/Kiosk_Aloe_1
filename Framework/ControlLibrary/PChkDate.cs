...
{
	public partial class PChkDate : DevExpress.XtraEditors.XtraUserControl
	{
		public PChkDate()
		{
			InitializeComponent();
		...
		{
			get { return chk.Checked ? DateFrom.EditValue : null; }
		...
		{
			get { return chk.Checked ? DateTo.EditValue : null; }
		...
		public void SetSuperToolTip(string title, string contents)
		{
			...
			sTip.Items.Add(tContents); DateFrom.SuperTip = sTip;
		...
		private void PChkDate_Load(object sender, EventArgs e)
		{
