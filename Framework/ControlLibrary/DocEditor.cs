...
{
	public partial class DocEditor : DevExpress.XtraEditors.XtraUserControl
	{
        ///////////////////////////////////////////////////////////////////////////////////////////////
		...
		public bool OpenDocument(byte[] bytes, string strDocType)
		{
			try
			{
				...
				{
					case "HTML":
						richEdit.Document.HtmlText = System.Text.Encoding.Unicode.GetString(bytes); 
