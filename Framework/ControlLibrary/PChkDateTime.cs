...
{
	public partial class PChkDateTime : DevExpress.XtraEditors.XtraUserControl
	{
		public PChkDateTime()
		{
			InitializeComponent();
		...
		{
			get { return chk.Checked ? (object)DateTimeFrom.Value : null; }
			set { DateTimeFrom.Value = value==null?DateTime.Now:(DateTime)value; }
		}
		...
		{
			get { return chk.Checked ? (object)DateTimeTo.Value : null; }
			set { DateTimeTo.Value = value == null ? DateTime.Now : (DateTime)value; }
		}
		...
		public void SetSuperToolTip(string title, string contents)
		{
			...
			sTip.Items.Add(tContents); chk.SuperTip = sTip;
		...
		protected override void OnLostFocus(EventArgs e)
		{
			...
			if (_checkModify)
			{
				if (DateTimeFrom.Enabled)
				{
					(FindForm() as UIFrame).Enabled = false;
				}
			}
		}
		#endregion

		private void PChkDateTime_Load(object sender, EventArgs e)
		{
			DateTimeFrom.Value = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
			DateTimeTo.Value = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
		}
	}
}
