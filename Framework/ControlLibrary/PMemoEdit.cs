...
namespace TLF.Framework.ControlLibrary
{
    ...
    /// 
    /// </remarks>
    public partial class PMemoEdit : DevExpress.XtraEditors.MemoEdit
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: WordWrap :: 줄바꿈 가능여부를 설정합니다.

        /// <summary>
        /// 줄바꿈 가능여부를 설정합니다.
        /// </summary>
        [Category(AppConfig.CONTROLCATEGORY)]
        [Description("줄바꿈 가능여부를 설정합니다."), Browsable(true)]
        public bool WordWrap
        {
            get { return this.Properties.WordWrap; }
            set { this.Properties.WordWrap = value; }
        }
