...
namespace TLF.Framework.PopUp
{
    ...
    /// 
    /// </remarks>
    public partial class ProductInfoPopup : TLF.Framework.BaseFrame.PopupFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void _Save(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dt = viewGetProductInfo.GetAddedModifedData();
        ...
        {
            viewGetProductInfo.BeginInit();
            viewGetProductInfo.InitGridColumn("ItemSeq                      ", "No                      ", 70, 0, false, false, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("CustSeq                      ", "거래처번호              ", 70, 0, false, false, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("CustNm                       ", "거래처명                ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ItemNo                       ", "PART NO                 ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ItemNm                       ", "PART NAME               ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ItemGB                       ", "제품 구분                ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ModelCd                      ", "DOCUMENT NO             ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ItemCls1                     ", "대분류                  ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ItemCls2                     ", "중분류                  ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("ItemCls3                     ", "소분류                  ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("UnitCd                       ", "단위                    ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("Spec                         ", "규격                    ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("MaterialCd                   ", "재질                    ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("Thickness                    ", "두께                    ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("Weight                       ", "무게                    ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("Yield                        ", "수율                    ", 70, 0, false, true, ColumnDataType.Numeric, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("Margin                       ", "여유율                  ", 70, 0, false, true, ColumnDataType.Numeric, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("Remark                       ", "비고                    ", 70, 0, false, true, ColumnDataType.Default, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("UseYn                        ", "사용 여부                ", 70, 0, false, true, ColumnDataType.CheckEdit, HorzAlignment.Near);
            viewGetProductInfo.InitGridColumn("InspYn                       ", "검사 여부                ", 70, 0, false, false, ColumnDataType.CheckEdit, HorzAlignment.Near);
            viewGetProductInfo.InitComboBoxColumn("ItemGB", MesCodeUtil.GetCodeMaster("MD_ITEMGB", ""), false, false);
            viewGetProductInfo.InitComboBoxColumn("ItemCls1", MesCodeUtil.GetCodeMaster("MD_ItemCls1", ""), false, false);
            viewGetProductInfo.InitComboBoxColumn("ItemCls2", MesCodeUtil.GetCodeMaster("MD_ItemCls2", ""), false, false);
            viewGetProductInfo.InitComboBoxColumn("ItemCls3", MesCodeUtil.GetCodeMaster("MD_ItemCls3", ""), false, false);
            viewGetProductInfo.InitComboBoxColumn("UnitCd", MesCodeUtil.GetCodeMaster("UnitCd", ""), false, false);
            viewGetProductInfo.InitComboBoxColumn("ModelCd", MesCodeUtil.GetCodeMaster("MD_ModelCd", ""), false, false);
            viewGetProductInfo.InitComboBoxColumn("MaterialCd", MesCodeUtil.GetCodeMaster("MD_MaterialCd", ""), false, false);


            viewGetProductInfo.EndInit();
        }
        ...
        private void SelectionData()
        {
            ...
            using (var wb = new WsBiz(AppConfig.MESDB))
            {
                ...
                gridGetProductInfo.FillGrid(ds);
                viewGetProductInfo.BestFitColumns();
            }
        }
        ...
        private bool CheckDeleteCondition()
        {
            ...
            if (viewGetProductInfo.GetFocusedDataRow() == null)
            {
                MsgBox.Show("삭제할 공지사항을 선택해 주세요", "삭제 확인");
                return false;
            }

            string message = String.Format("공지사항 [ {0} ] 을(를) 삭제하시겠습니까?", viewGetProductInfo.GetFocusedDataRow()["Title"]);
        ...
        private void view_L_PP0321_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                DataSet dataSet;
                DataRow dr = viewGetProductInfo.GetFocusedDataRow();
